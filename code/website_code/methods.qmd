...
It is important to note that we chose to force the user to scroll horizontally throughout the plot in order to view the legend as well as some of the most recent years. This was a choice we made to optimize text size and keep the plots aligned along the margins. The other option was to drastically shrink the text size in the plot, which we felt would be detrimental to the overall ability for the user to view the plot.
...
Similar to Figure 9, we chose to force the user to scroll horizontally throughout the plot. This was a choice we made to optimize text size and keep the plots aligned along the margins. The other option was to shrink the text size in the plot, which we felt would be detrimental to the overall ability for the user to view the plot.
...
Similar to Figure 9 and Figure 10, we chose to keep the font size large enough that would require the user to scroll a bit to see the legend and the larger banks in terms of equity capital. We made this choice to allow the font to be more readable, while sacrificing the ability to see the whole plot.