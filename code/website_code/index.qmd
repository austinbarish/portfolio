...
::: {.callout-note}
For this innovative view, we included both a heatmap and a dot map on a Folium object. This view allows us to see clearly that the density of banks in a region does not strongly impact the size of banking assets in a state, but rather, whether large banks have moved to that state. These elements foreshadow the discussion in the sections to come.
:::
...
#### **Assets Held by the Top 4 Banks in 2022 in Comparison to All Others** {#sec-top-banks .unnumbered}
...
#### **The Distribution of Commercial Banks in the US by the Assets in Possession for 2022Q4** {#sec-top-commercial .unnumbered}
...
width_percentage = "100%"
IFrame(src='../website/plots/eqr/plot3.html', width=width_percentage, height=600)
...
width_percentage = "100%"
IFrame(src='../website/plots/eqr/plot4.html', width=width_percentage, height=600)
